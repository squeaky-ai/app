...
import { TagsRageClicked } from 'components/sites/filters/recordings/tags-rage-clicked';
import { TagsUTurned } from 'components/sites/filters/recordings/tags-u-turned';
...
export const Tags: FC<Props> = ({ filters, updateFilters, clearFilters }) => {
  ...
  const hasRageClicked = filters.rageClicked !== null;
  const hasUTurned = filters.uTurned !== null;
  ...
  return (
    <div className='filter-tags'>
      ...
      {hasRageClicked && (
        <TagsRageClicked filters={filters} updateFilters={updateFilters} />
      )}

      {hasUTurned && (
        <TagsUTurned filters={filters} updateFilters={updateFilters} />
      )}
