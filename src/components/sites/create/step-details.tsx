...
export const StepDetails: FC<Props> = ({ site, siteType, handleForward, handleBack }) => {
  ...
  return (
    <div className='step step-details'>
      ...
      <Formik
        initialValues={{ name: site?.name || '', protocol: getSiteUrlParts(site)[0], hostname: getSiteUrlParts(site)[1] }}
        ...
        onSubmit={(values, { setSubmitting, setErrors, setFieldValue }) => {
          (async () => {
            try {
              ...
              const site = await createSite(name, url); // TODO: Add type
              handleForward(site);
            } catch(error: any) {
        ...
        {({
          ...
          <form onSubmit={handleSubmit} className='fade-in'>
            ...
            <div className='footer'>
              <Button className='quaternary' type='button' onClick={handleBack} disabled={isSubmitting}>
                Back
              </Button>
