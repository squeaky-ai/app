...
import { SITE_COLUMNS as COLUMNS } from 'data/admin/constants';
...
export const SitesColumns: FC<Props> = ({ columns, setColumns }) => {
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    Preferences.setArray(Preference.ADMIN_SITES_COLUMNS, result.map(r => r.position));
