...
import { USER_COLUMNS as COLUMNS } from 'data/admin/constants';
...
export const UsersColumns: FC<Props> = ({ columns, setColumns }) => {
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    Preferences.setArray(Preference.ADMIN_USERS_COLUMNS, result.map(r => r.position));
