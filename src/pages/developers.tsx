              ...
              },
              {
                ...
                body: (
                  <>
                    ...
                    <pre className='code block'>
                      <code className='language-typescript'>{`import NextDocument, { Html, Head, Main, NextScript, DocumentContext } from 'next/document';
...
export default Document;`}
          ...
          <pre className='code block'>
            <code className='language-html'>{`<div class="squeaky-hide">
  <p>Name: Bob</p>
  ...
  <img src="/images/profile-image.png">
          ...
          <pre className='code block'>
            <code className='language-html'>{`<p>Welcome back, <span class="squeaky-mask">Bob</span></p>`}
            </code>
          </pre>

          <h4>User Indentification</h4>
          <p>Privacy is important, however there are times that you may want to link some attributes to a Squeaky visitor. By default, a visitor is completely annoymous, although the site owner can associate any attributes they want with a visitor.</p>
          ...
          <pre className='code block'>
            <code className='language-typescript'>{`squeaky.identify('<your-users-uniqueid>', {
  foo: 'bar',
  bar: 'baz',
  ...
});`}
              ...
              },
              {
                ...
                body: (
                  <>
                    ...
                    <pre className='code block'>
                      <code className='language-typescript'>{`import React, { FC } from 'react';
