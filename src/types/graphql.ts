...
export type Mutation = {
  __typename?: 'Mutation';
  adminDeleteImage: FiltersSuccess;
  adminSignImageUpload: AdminBlogSignImage;
...
export type MutationAdminSignImageUploadArgs = {
...
export type Query = {
  ...
  blogImagesAdmin: Array<Maybe<Scalars['String']>>;
