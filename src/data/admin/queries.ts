...
export const GET_AD_TRACKING_QUERY = gql`
  query GetAdTracking($utmContentIds: [String!]!, $page: Int!, $size: Int!, $sort: AdminAdTrackingSort!, $fromDate: ISO8601Date!, $toDate: ISO8601Date!) {
    admin {
      adTracking(utmContentIds: $utmContentIds, page: $page, size: $size, sort: $sort, fromDate: $fromDate, toDate: $toDate) {
        items {
          siteId
          siteName
          siteCreatedAt {
